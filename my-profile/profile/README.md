...
{% hint style="info" %}
![](<../../.gitbook/assets/image (47).png>) shows that the Email address is your primary Email address.
{% endhint %}
...
1. Click ![](<../../.gitbook/assets/image (51).png>) icon on the profile complete page.
...
1. Click ![](<../../.gitbook/assets/image (61).png>) icon on the profile completion page.
